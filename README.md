...
- **Mock tests**: for every section you now enter *correct*, *incorrect*,
  ...
  score, accuracy), an overall percentage, a pie chart of correct /
  incorrect / not attempted with percentages, a section-wise bar chart,
  and a score trend line chart. The latest mock score and percentage also
